...
class tmtSetCriterion(nn.Module):
    ...
    def loss_masks(self, outputs, targets, indices, num_masks):
        ...
        losses = {
            "loss_tmt_mask": sigmoid_ce_loss_jit(point_logits, point_labels, num_masks),
            "loss_tmt_dice": dice_loss_jit(point_logits, point_labels, num_masks),
        }
    ...
    def get_loss(
        ...
        loss_map = {
            'tmt_labels': self.loss_labels,
            'tmt_masks': self.loss_masks,
