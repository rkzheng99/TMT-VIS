...
class tmt(nn.Module):
    ...
    def __init__(
        ...
        *,
        ...
        weight_init.c2_xavier_fill(self.tmt_mask_features)
    ...
    def from_config(cls, cfg, in_channels):
        ...
        ret["hidden_dim"] = cfg.MODEL.tmt.HIDDEN_DIM
        ret["num_frame_queries"] = cfg.MODEL.MASK_FORMER.NUM_OBJECT_QUERIES
        ret["num_queries"] = cfg.MODEL.tmt.NUM_OBJECT_QUERIES
        # Transformer parameters:
        ret["nheads"] = cfg.MODEL.tmt.NHEADS
        ret["dim_feedforward"] = cfg.MODEL.tmt.DIM_FEEDFORWARD

        assert cfg.MODEL.tmt.DEC_LAYERS >= 1
        ret["enc_layers"] = cfg.MODEL.tmt.ENC_LAYERS
        ret["dec_layers"] = cfg.MODEL.tmt.DEC_LAYERS
        ret["enc_window_size"] = cfg.MODEL.tmt.ENC_WINDOW_SIZE
        ret["pre_norm"] = cfg.MODEL.tmt.PRE_NORM
        ret["enforce_input_project"] = cfg.MODEL.tmt.ENFORCE_INPUT_PROJ

        ret["num_classes"] = cfg.MODEL.SEM_SEG_HEAD.NUM_CLASSES
        ret["num_frames"] = cfg.INPUT.SAMPLING_FRAME_NUM
        ret["clip_last_layer_num"] = cfg.MODEL.tmt.LAST_LAYER_NUM

        ret["conv_dim"] = cfg.MODEL.SEM_SEG_HEAD.CONVS_DIM
        ret["mask_dim"] = cfg.MODEL.SEM_SEG_HEAD.MASK_DIM
        ret["sim_use_clip"] = cfg.MODEL.tmt.SIM_USE_CLIP
        ret["use_sim"] = cfg.MODEL.tmt.SIM_WEIGHT > 0.0
