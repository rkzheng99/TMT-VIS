...
from .datasets.ytvis import COCO_TO_YTVIS_2019, COCO_TO_YTVIS_2021, OVIS_ca_TO_YTVIS_2019,OVIS_TO_YTVIS_2019, UVO_TO_YTVIS_2019
from tmt.data.datasets.ovis import COCO_TO_OVIS
        ...
        *,
        ...
        if not is_tgt:
            ...
            if tgt_dataset_name.startswith("ytvis_2019"):
                if src_dataset_name.startswith("ovis"):
                    src2tgt = OVIS_TO_YTVIS_2019
                if src_dataset_name.startswith("uvo"):
                    src2tgt = UVO_TO_YTVIS_2019
