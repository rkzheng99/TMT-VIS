...
__all__ = ["load_uvo_json", "register_uvo_instances"]

UVO_CA_CATEGORIES = [{"color": [220, 20, 60], "isthing": 1, "id": 1, "name": "object"}]
...
UVO_CATEGORIES = [
    ...
    {"color": [233, 233, 233], "isthing": 1, 'id': 91, 'name': 'other'},
]
...
def load_uvo_json(json_file, image_root, dataset_name=None, extra_annotation_keys=None):
...
"""
    ...
    for (vid_dict, anno_dict_list) in vids_anns:
        ...
        # record["file_names"] = [os.path.join(image_root, file_name) for file_name in vid_dict["file_names"]]
...
def register_uvo_instances(name, metadata, json_file, image_root):
    ...
    DatasetCatalog.register(name, lambda: load_uvo_json(json_file, image_root, name))
...
if __name__ == "__main__":
    ...
    meta = MetadataCatalog.get("uvo_dense_train")

    json_file = "/group/20018/gavinqi/data/uvo/VideoDenseSet/UVO_video_train_dense.json"
    image_root = "/group/20018/gavinqi/data/uvo/uvo_videos_dense"
    dicts = load_uvo_json(json_file, image_root, dataset_name="uvo_")
